...
import SideNavGroup, { SideNavGroupProps } from './SideNavGroup';
import Link from '../Link';

# SideNav

The `SideNav` (aka Sidebar) of the application.
`SideNavGroup` components will expand when selected.
...
### SideNavGroup
<PropsTable of={SideNavGroupProps} />

### SideNavItem
<PropsTable of={SideNavItemProps} />
